                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <button type="submit" class="btn btn-warning" name="ubahjenis" onclick="return confirm('Apakah Anda yakin akan mengubah data jenis barang ini?')">Ubah</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-danger">
                                                        <h4 class="modal-title text-white">Hapus Jenis Barang</h4>
                                                        <button type="button" class="btn-close bg-white" data-bs-dismiss="modal"></button>
                                                    </div>
                                                    <form method="post">
                                                        <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title text-white">Jenis Barang</h4>
                <button type="button" class="btn-close bg-white" data-bs-dismiss="modal"></button>
            </div>
            <form method="post">
                <div class="modal-body">
                    ...
                    <br>
                    <button type="submit" class="btn btn-success" name="jenisbarangmasuk" onclick="return confirm('Apakah Anda yakin akan menambah data jenis barang ini?')">Simpan</button>
                </div>
            </form>
        </div>
    </div>
