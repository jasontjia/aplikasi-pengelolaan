                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <button type="submit" class="btn btn-warning" name="ubahbarang">Ubah</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <br>
                        <h6>Harga Beli</h6>
                        <input type="text" name="harga_beli" placeholder="Harga Beli" class="form-control" required>
                        <br>
                        <h6>Harga Jual</h6>
                        ...
                        <br>
                        <button type="submit" class="btn btn-success" name="addnewbarang">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
